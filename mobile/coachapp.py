...
list_title = 'Here is the list of athletes:'
quit_msg = "Quitting Coach Kelly's App"
web_server = 'http://192.168.1.112:8080'
...
athletes = json.loads(send_to_server(web_server + get_names_cgi))
athlete_names = sorted([athlete[0] for athlete in athletes])
